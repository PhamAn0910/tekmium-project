> [!NOTE]
> This file was exported by AgentKit's best-effort, non-production "portable"
> target. It was originally written for Claude Code: tool names in
> frontmatter and inline code were rewritten to generic capability phrases,
> but prose below may still describe Claude-Code-specific behavior — map it
> to your host runtime's equivalents. No named model is prescribed. See
> PORTABLE.md at the root of this export for full scope and limitations.
